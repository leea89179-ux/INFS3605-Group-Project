export const FH_COST_DATA = {
  indexPatientEstimatedCash: "S$18–S$87",
  cardHeading: "ESTIMATED OUT-OF-POCKET COST",
  supportingText: "For an index patient with S$500 available under MediSave500. Final payment depends on subsidy eligibility and available MediSave. The package includes pre-test counselling, genetic testing, blood drawing and post-test counselling.",
