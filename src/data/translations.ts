...
export const UI_TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Settings Screen
    settings_title: 'Your Communication Settings',
    ...
    lock_counselling_confirmed_msg: 'Your genetic counseling is confirmed for {date} at {time}. Tap to complete checklist.',
    ...
    lockscreen_push_msg: 'Your genetic counseling is confirmed for {date} at {time}. Tap to complete checklist.',
  ...
  ms: {
    ...
    settings_title: 'Tetapan Komunikasi Anda',
  ...
  ta: {
    ...
    settings_title: 'உங்கள் தொடர்பு அமைப்புகள்',
...
export const getLocalizedChecklist = (lang: Language) => {
  switch (lang) {
    case 'ms':
      return [
        { id: 'prep-1', text: 'Sejarah keluarga — siapa yang mempunyai kolesterol tinggi atau serangan jantung, dan pada umur berapa?', checked: false },
        ...
        { id: 'prep-5', text: 'Tidak perlu berpuasa — makan dan minum secara normal terlebih dahulu.', checked: false },
      ];
    case 'zh':
      return [
        { id: 'prep-1', text: '家族病史 — 谁曾患有高胆固醇或心脏病突发？发病年龄是多少？', checked: false },
        ...
        { id: 'prep-5', text: '无需空腹 — 咨询前可正常饮食和饮水。', checked: false },
      ];
    case 'ta':
      return [
        { id: 'prep-1', text: 'குடும்ப வரலாறு — யாருக்கு அதிக கொழுப்பு அல்லது மாரடைப்பு ஏற்பட்டது, எந்த வயதில்?', checked: false },
        ...
        { id: 'prep-5', text: 'உண்ணாவிரதம் தேவையில்லை — முன்னதாக சாதாரணமாக சாப்பிட்டு குடிக்கவும்.', checked: false },
      ];
    case 'en':
    default:
      return [
