...
export const VISUAL_CARDS_DB: Record<Language, Record<string, {
  ...
  zh: {
    ...
    'testing-process': {
      ...
      points: {
        beginner: [
          { icon: "🗣️", label: "检测咨询", text: "30分钟门诊评估，详尽绘制家族谱系并解答您的各种隐私疑虑。" },
          { icon: "💉", label: "样本采集", text: "抽血采样仅需10分钟，且完全无需提前进行任何空腹或禁食。" },
          { icon: "📅", label: "结果解读", text: "4至6周后回诊会见专家，为您量身制定后续防病和关怀方案。" }
        ],
        advanced: [
          { icon: "🗣️", label: "预检咨询", text: "绘制至少三代家族谱系图并评估心血管风险，签署知情同意。" },
          { icon: "💉", label: "高通量测序", text: "采集外周血或唾液，行高通量二代测序（NGS）深度扫描致病变异。" },
          { icon: "📅", label: "变异解读", text: "遗传专家精确分析基因结果，并引导亲属启动家系级联筛查。" }
        ]
      }
    },
    'costs-subsidies': {
      ...
      points: {
        beginner: [
          { icon: "🇸🇬", label: "政府资助", text: "合资格的新加坡公民可获得高达 75% 的 MOH 政府专项补贴。" },
          { icon: "🏦", label: "保健储蓄", text: "补贴后的自付余额，支持 100% 通过个人 MediSave 支付。" },
          { icon: "💵", label: "零现金自付", text: "绝大多数患者在补贴与 MediSave 的支持下无需自掏腰包。" }
        ],
        advanced: [
          { icon: "🇸🇬", label: "政府专项补贴", text: "卫生部（MOH）为符合资质的公民提供 50% 至 75% 临床财政补贴。" },
          { icon: "🏦", label: "慢性病 MediSave", text: "自付余额可在 CDMS 慢性病门诊机制内完全报销，减轻现金流负担。" },
          { icon: "💵", label: "多重兜底保障", text: "低收入居民可申请 CHAS Blue 或 Medifund 获得完全免费的补助。" }
        ]
      }
    },
    'insurance': {
  ...
  ta: {
    'what-is-fh': {
      ...
      points: {
        beginner: [
          { icon: "🧬", label: "பரம்பரை", text: "குடும்ப மரபணுக்கள் மூலம் பரவுகிறது, உணவு அல்லது வாழ்க்கை முறை அல்ல." },
          { icon: "📈", label: "அதிக LDL", text: "பிறப்பிலிருந்தே 'கெட்ட' கொலஸ்ட்ரால் மிக அதிகமாக உள்ளது." },
          { icon: "🛡️", label: "சிகிச்சை பெறலாம்", text: "ஆரம்பகால மருத்துவ ஆதரவுடன் எளிதாகக் குணப்படுத்த முடியும்." }
        ],
        advanced: [
          { icon: "🧬", label: "மரபணு பிறழ்வு", text: "LDLR, APOB அல்லது PCSK9 மரபணுக்களில் ஏற்படும் டாமினண்ட் மாற்றம்." },
          { icon: "📈", label: "குறைந்த அகற்றல்", text: "கல்லீரலால் LDL-C கொழுப்பை அகற்றுவது குறைகிறது." },
          { icon: "🛡️", label: "மருந்து சிகிச்சை", text: "துல்லியமான சிகிச்சைகள் இதய நோய் ஆபத்தைக் கணிசமாகக் குறைக்கின்றன." }
        ]
      }
    },
    'heart-health': {
    ...
    'genetic-testing': {
      ...
      points: {
        beginner: [
          { icon: "🩸", label: "எளிய சோதனை", text: "வெளிநோயாளியாக 10 நிமிடத்தில் செய்யப்படும் எளிய இரத்தப் பரிசோதனை." },
          { icon: "🔍", label: "துல்லிய DNA", text: "LDLR, APOB, அல்லது PCSK9 போன்ற மரபணுக்களை ஆராய்கிறது." },
          { icon: "📋", label: "தெளிவான வழிகாட்டுதல்", text: "முடிவுகள் துல்லியமான சிகிச்சையைத் தேர்வு செய்ய உதவும்." }
        ],
        advanced: [
          { icon: "🩸", label: "மூலக்கூறு சோதனை", text: "FH உடன் தொடர்புடைய மரபணுக்களை கண்டறிய NGS தொழில்நுட்பம் பயன்பாடு." },
          { icon: "🔍", label: "மரபணு வகை கண்டறிதல்", text: "நோயறிதலில் உள்ள சந்தேகங்களைத் தீர்த்து துல்லியமான முடிவுகளைத் தரும்." },
          { icon: "📋", label: "குடும்பப் பரிசோதனை", text: "குடும்பத்தினருக்குச் சோதனை செய்ய இது ஒரு முக்கியமான வழிகாட்டியாகும்." }
        ]
      }
    },
    'cascade-screening': {
      ...
      points: {
        beginner: [
          { icon: "👥", label: "50% ஆபத்து", text: "உங்களது நெருங்கிய உறவினர்களுக்கு இந்த பாதிப்பு ஏற்பட 50% வாய்ப்பு உண்டு." },
          { icon: "🌳", label: "குடும்ப மரம்", text: "உங்களுக்கு பாதிப்பு இருந்தால் மற்ற உறுப்பினர்களை எளிதாகச் சோதிக்கலாம்." },
          { icon: "🛡️", label: "ஆரம்ப நடவடிக்கை", text: "அடைப்பு ஏற்படுவதற்கு முன் உங்கள் குடும்பத்தைக் காக்க உதவும்." }
        ],
        advanced: [
          { icon: "👥", label: "மரபியல் வாய்ப்பு", text: "நெருங்கிய உறவினர்களுக்கு 50% மரபு வாய்ப்பு உள்ளது." },
          { icon: "🌳", label: "இலக்கு சோதனை", text: "பாதிக்கப்பட்டவரின் பிறழ்வைக் கொண்டு குடும்ப உறுப்பினர்களை எளிதாகச் சோதித்தல்." },
          { icon: "🛡️", label: "செலவு சேமிப்பு", text: "உலகளவில் பொருளாதார ரீதியாகப் பரிந்துரைக்கப்படும் சிறந்த தடுப்பு முறை." }
        ]
      }
    },
    'treatment-medication': {
      ...
      points: {
        beginner: [
          { icon: "💊", label: "பாதுகாப்பான மருந்துகள்", text: "கல்லீரலில் கொழுப்பை அகற்ற உதவும் எளிய மற்றும் பாதுகாப்பான ஸ்டாடின் மாத்திரைகள்." },
          { icon: "🔄", label: "LDL சுத்தம்", text: "உடலின் இயற்கை ஏற்பிகளின் திறனை அதிகரித்து கொழுப்பை நீக்குகிறது." },
          { icon: "📉", label: "ஆபத்து குறைப்பு", text: "மாரடைப்பு ஏற்படும் அபாயத்தை முழுமையாகக் குறைக்கிறது." }
        ],
        advanced: [
          { icon: "💊", label: "ஸ்டாடின் சிகிச்சை", text: "அதிக திறன் கொண்ட ஸ்டாடின் மருந்துகள் கொழுப்பு உற்பத்தியைத் தடுக்கின்றன." },
          { icon: "🔄", label: "LDLR அதிகரிப்பு", text: "இரத்தத்தில் இருந்து LDL கொழுப்பை உறிஞ்சும் கல்லீரல் வாங்கிகளை ஊக்குவித்தல்." },
          { icon: "📉", label: "கூட்டுச் சிகிச்சை", text: "தேவைக்கேற்ப Ezetimibe அல்லது PCSK9 தடுப்பான்களுடன் இணைந்து பயன்படுத்தப்படுகிறது." }
        ]
      }
    },
    'healthy-lifestyle': {
      ...
      points: {
        beginner: [
          { icon: "🍎", label: "அதிக நார்ச்சத்து", text: "கொழுப்பு உறிஞ்சப்படுவதைத் தடுக்க ஓட்ஸ், பீன்ஸ் போன்றவற்றைத் தேர்ந்தெடுக்கவும்." },
          { icon: "🚫", label: "கொழுப்புத் தவிர்ப்பு", text: "வெண்ணெய், தேங்காய் எண்ணெய், கொழுப்பு இறைச்சிகளைக் குறைக்கவும்." },
          { icon: "🏃‍♂️", label: "உடற்பயிற்சி", text: "இதயத்தை வலுப்படுத்த தினமும் 30 நிமிடங்கள் வேகமாக நடக்கவும்." }
        ],
        advanced: [
          { icon: "🍎", label: "நார்ச்சத்து உணவு", text: "நார்ச்சத்து உணவுகள் குடலில் கொழுப்பு உறிஞ்சப்படுவதைத் தடுக்கின்றன." },
          { icon: "🚫", label: "வாங்கித் தடை", text: "அதிக கொழுப்பு உணவுகள் கல்லீரல் LDL வாங்கிகளின் திறனைக் குறைக்கின்றன." },
          { icon: "🏃‍♂️", label: "இரத்த ஓட்டம்", text: "ஏரோபிக் உடற்பயிற்சி இரத்த ஓட்டத்தை மேம்படுத்த இன்றியமையாதது." }
        ]
      }
    },
    'testing-process': {
      ...
      points: {
        beginner: [
          { icon: "🗣️", label: "ஆலோசனை", text: "30 நிமிடத்தில் உங்களின் குடும்பப் பின்னணி மற்றும் தனியுரிமை விளக்கம்." },
          { icon: "💉", label: "இரத்த மாதிரி", text: "எளிய 10 நிமிட வெளிநோயாளி இரத்தப் பரிசோதனை, விரதம் தேவையில்லை." },
          { icon: "📅", label: "முடிவுகள் ஆய்வு", text: "4-6 வாரங்களில் உங்களின் தனிப்பயனாக்கப்பட்ட சிகிச்சைத் திட்டம்." }
        ],
        advanced: [
          { icon: "🗣️", label: "முன்னோடி ஆலோசனை", text: "மூன்று தலைமுறை குடும்ப வரலாற்றை ஆராய்ந்து ஆலோசனை வழங்குதல்." },
          { icon: "💉", label: "மூலக்கூறு மாதிரி", text: "விரதமில்லா எளிய இரத்த மாதிரி மூலம் NGS சோதனை மேற்கொள்ளப்படுகிறது." },
          { icon: "📅", label: "முடிவுகள் பகுப்பாய்வு", text: "மரபணு முடிவுகளைப் பகுப்பாய்வு செய்து உரிய பாதுகாப்பு சிகிச்சை அளித்தல்." }
        ]
      }
    },
    'costs-subsidies': {
      ...
      points: {
        beginner: [
          { icon: "🇸🇬", label: "அரசு மானியம்", text: "தகுதியுள்ள குடிமக்களுக்கு 75% வரை அரசு மானியம் வழங்கப்படுகிறது." },
          { icon: "🏦", label: "MediSave", text: "மீதமுள்ள தொகையை உங்களது MediSave மூலம் முழுமையாகச் செலுத்தலாம்." },
          { icon: "💵", label: "பணச் செலவின்மை", text: "பெரும்பாலானோர் கையில் இருந்து பணம் செலுத்த வேண்டியதில்லை." }
        ],
        advanced: [
          { icon: "🇸🇬", label: "அரசு மானியம்", text: "சுகாதார அமைச்சகம் (MOH) தகுதியுள்ளோருக்கு 50% முதல் 75% வரை மானியம் வழங்குகிறது." },
          { icon: "🏦", label: "CDMS MediSave", text: "மீதமுள்ள தொகையை CDMS திட்டத்தின் கீழ் MediSave மூலம் செலுத்தலாம்." },
          { icon: "💵", label: "கூடுதல் உதவிகள்", text: "கூடுதல் நிதிப் பாதுகாப்பு CHAS மற்றும் Medifund மூலம் உறுதி செய்யப்படுகிறது." }
        ]
      }
    },
    'insurance': {
      ...
      points: {
        beginner: [
          { icon: "🛡️", label: "LIA உடன்படிக்கை", text: "மரபணு சோதனை முடிவுகளைக் கேட்க காப்பீட்டு நிறுவனங்களுக்குத் தடை." },
          { icon: "🔒", label: "காப்பீடு பாதுகாப்பு", text: "உங்களிடம் இருக்கும் பழைய காப்பீடுகளை ரத்து செய்ய முடியாது." },
          { icon: "✅", label: "சாதாரண காப்பீடு", text: "சாதாரண விதிமுறைகளின் கீழ் காப்பீடுகளைப் பெற முழுத் தகுதியுண்டு." }
        ],
        advanced: [
          { icon: "🛡️", label: "LIA Moratorium", text: "சுயவிவர மரபணு சோதனைகளைப் பயன்படுத்திப் பயமுறுத்துவதை இது தடுக்கிறது." },
          { icon: "🔒", label: "மாற்றமின்மை", text: "ஏற்கனவே இருக்கும் காப்பீட்டுக்கான பிரீமியம் அல்லது பலன்கள் மாறாது." },
          { icon: "✅", label: "சாதாரண விதிமுறைகள்", text: "குறிப்பிட்ட தொகைக்கு உட்பட்ட காப்பீடுகளைச் சாதாரண நிபந்தனைகளில் பெறலாம்." }
        ]
      }
    }
  }
