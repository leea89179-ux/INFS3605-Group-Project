      ...
      .catch((err) => {
        ...
        setTimeout(() => {
          ...
          if (query.includes('insurance') || query.includes('shield') || query.includes('policy') || query.includes('insurans') || query.includes('保险') || query.includes('காப்பீடு')) {
            ...
            botResponse = "FH testing is subsidized by up to **70%** by MOH for eligible Singapore Citizens and Permanent Residents. After subsidies, an index patient may pay an estimated **S$18 to 87** cash with S$500 available under MediSave500. **MediSave500/700** may be used after subsidies, subject to available balance and annual limits.";
